...
SELECT
  ...
  CONCAT("<a href='https://covertech-873987ba3.sentry.io/issues/?environment=prod&project=4505878638559232&query=is%3Aunresolved+route%3A%22", "*", COALESCE(SUCCESS_CTE.host, FAIL_CTE.host) || COALESCE(SUCCESS_CTE.route, FAIL_CTE.route), "*", "%22&referrer=issue-list&statsPeriod=30d'>View Issues</a>") AS `view_issues`
FROM SUCCESS_CTE
